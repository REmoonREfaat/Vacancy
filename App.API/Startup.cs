...
namespace App.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //                      builder =>
            //                      {
            //                          builder.WithOrigins("https://localhost:44395", "https://vision.sbtechnology.host",
            //                              "https://adminvision.sbtechnology.host")
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    { Title = "APP API Documentation ", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.DocExpansion(Swashbuckle.AspNetCore.SwaggerUI.DocExpansion.None);
                c.SwaggerEndpoint($"{swaggerJsonBasePath}/swagger/v1/swagger.json", "Remon Vacancy API V1");
            });
        ...
        private static void RegisterCustomTypesInIoC(IServiceCollection services)
        {
            ...
            services.AddScoped<IApplicantVacancyService, ApplicantVacancyService>();

            services.AddHostedService<Services.ExpiredVacancyArchiver>();
